public class SimpleQueue {
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // FIXED: Add to the back of the queue, not the front
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // FIXED: Get the front element (index 0)
        _queue.RemoveAt(0);     // FIXED: Remove the front element (index 0)
        return value;
    }
}